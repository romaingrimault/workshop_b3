...
echo '<div class="card" id="propostion'.$proposition["id"].'" style="width: 600px;">
    <div class="card-body">
        ...
        <div class="voteon" onclick="vote('.$proposition["id"].')" style="display: none">
        ...
        <div class="voteoff" onclick="vote('.$proposition["id"].')" style="display: block">
...
<script>
    function vote(idPropostion) {
        ...
        if(voteoff[0].style['display']=="block"){
            ...
            xhttp.open("POST", "./ajax/forum-ajax.php", true);
            xhttp.send(idPropostion);
